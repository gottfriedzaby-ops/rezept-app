...
| 19 | Nutrition Tracking | Yazio-style food diary + personalized calorie/macro goals (BMR/TDEE), photo-based estimation (Claude Vision), and an intermittent-fasting tracker (live timer, 16:8/18:6/20:4/OMAD). Phases 1–3 shipped | ✅ Phases 1–3 | [19-nutrition-tracking.md](./19-nutrition-tracking.md) |
